...
(0, _ava2.default)('test font', async t => {
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(delta, 'arguments/0/left') instanceof _rec5._capt(_quillDelta2.default, 'arguments/0/right'), 'arguments/0'), {
    content: 't.true(delta instanceof Delta, \'class check\')',
    filepath: 'test/test-simple.js',
    line: 105,
    async: true,
  ...
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(delta, 'arguments/0/callee/object').hasOwnProperty('ops'), 'arguments/0'), {
    content: 't.true(delta.hasOwnProperty(\'ops\'), \'property check\')',
    filepath: 'test/test-simple.js',
    line: 106,
    async: true,
  ...
  t.is(delta.ops[b + 0].insert, 'ABC');
  t.is(delta.ops[b + 1].insert, 'DEFGHIJ');
  t.is(delta.ops[b + 1].attributes.font, 'Arial');
  t.is(delta.ops[b + 2].insert, 'KLM');
  t.is(delta.ops[b + 3].insert, '\n');
  t.is(delta.ops[b + 4].insert, 'NOPQRSTUVWXYZ');
  t.is(delta.ops[b + 4].attributes.font, 'Arial');
  t.is(delta.ops[b + 5].insert, '\n');
  t.is(delta.ops[b + 6].insert, 'abcdefghijklmnopqrstuvwxyz');
  t.is(delta.ops[b + 7].insert, '\n');
  ...
  t.is(delta.ops[b + 0].insert, 'ABC');
  t.is(delta.ops[b + 1].insert, 'DEFGHIJ');
  t.is(delta.ops[b + 1].attributes.font, 'Times');
  t.is(delta.ops[b + 2].insert, 'KLM');
  t.is(delta.ops[b + 3].insert, '\n');
  t.is(delta.ops[b + 4].insert, 'NOPQRSTUVWXYZ');
  t.is(delta.ops[b + 4].attributes.font, 'Times');
  t.is(delta.ops[b + 5].insert, '\n');
  t.is(delta.ops[b + 6].insert, 'abcdefghijklmnopqrstuvwxyz');
  t.is(delta.ops[b + 7].insert, '\n');
  ...
  t.is(delta.ops[b + 0].insert, 'ABC');
  t.is(delta.ops[b + 1].insert, 'DEFGHIJ');
  t.is(delta.ops[b + 1].attributes.font, 'Hiragino Kaku Gothic stdN');
  t.is(delta.ops[b + 2].insert, 'KLM');
  t.is(delta.ops[b + 3].insert, '\n');
  t.is(delta.ops[b + 4].insert, 'NOPQRSTUVWXYZ');
  t.is(delta.ops[b + 4].attributes.font, 'Hiragino Kaku Gothic stdN');
  t.is(delta.ops[b + 5].insert, '\n');
  t.is(delta.ops[b + 6].insert, 'abcdefghijklmnopqrstuvwxyz');
  t.is(delta.ops[b + 7].insert, '\n');
...
//# sourceMappingURL=/Users/kent/WorkSpace/mygithub/rtf-to-quill-delta/node_modules/.cache/ava/08ea9f82bf918a1e560ac0476ec10508.js.map